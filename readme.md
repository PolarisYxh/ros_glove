...
rosrun prime_kinova_control prime_kinova_joint_control.py

//rosrun prime_kinova_control prime_kinova_control.py #控制机械臂的demo,有问题
```
左右手套一只即可，连接先连左手，食指控制上下，中指控制左右，无名指控制前后
问题：
机械臂usb线连usb2.0接口  
debug:
rostopic echo /j2n6s300_driver/in/joint_velocity  
